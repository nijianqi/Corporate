...
CREATE TABLE `company_address`  (
  ...
  `map_url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
-- ----------------------------
INSERT INTO `company_album` VALUES (1, '公司正面', NULL, 'http://image.znmya.com//94dcf9c72c28eb4e/9f9789441221c828.jpg', 'admin', '2018-05-27 10:32:24', 0, 1);
...
INSERT INTO `company_nav` VALUES (2, '关于我们', NULL, 'about-us.html', '_self', 'admin', '2018-05-28 09:32:36', 4, 0);
INSERT INTO `company_nav` VALUES (3, '新闻资讯', NULL, 'news.html', '_self', 'admin', '2018-05-28 09:15:07', 2, 0);
INSERT INTO `company_nav` VALUES (4, '诚聘英才', NULL, 'join-us.html', '_self', 'admin', '2018-05-28 09:32:46', 5, 0);
INSERT INTO `company_nav` VALUES (5, '联系我们', NULL, 'contact-us.html', '_self', 'admin', '2018-05-28 09:32:51', 6, 0);
...
INSERT INTO `company_nav` VALUES (8, '产品中心', NULL, 'project.html', '_self', 'admin', '2018-05-28 09:16:10', 3, 0);
...
CREATE TABLE `company_partner`  (
  ...
  `title_en` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `company_project`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `title_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `format` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `format_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `level` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `level_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `packing` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `packing_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `company_project_type` VALUES (1, 'POY', NULL, 1, 0, '2018-05-28 09:06:17', 'admin');
INSERT INTO `company_project_type` VALUES (2, 'FDY', NULL, 2, 0, '2018-05-28 09:06:26', 'admin');
INSERT INTO `company_project_type` VALUES (3, 'DTY', NULL, 3, 0, '2018-05-28 09:06:35', 'admin');
...
-- ----------------------------
INSERT INTO `company_slides` VALUES (1, '中国外贸家', NULL, 'uploads/obo/20171218/a447a08213e3e4e51cf5124b3f8ff087.jpg', 'bestsuppliers.html', '_blank', 'admin', '2018-05-26 18:02:58', 1, 0);
...
CREATE TABLE `system_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统菜单表' ROW_FORMAT = Dynamic;
