...
-- ----------------------------
INSERT INTO `company_address` VALUES ('1', '杭州总部', null, '400-880-1735', '0571-86160915', 'info@bestsuppliers.com', '中国杭州余杭区文一西路1218号恒生科技园35号楼', null, '311121', '', '0', '2018-05-26 18:48:35', 'admin');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统操作日志表';
